    ...
    return (
      <main className="min-h-screen bg-black">
        ...
        <div className="flex flex-col items-center justify-center mt-20 p-6">
          <div className="bg-pink-900 border-4 border-rose-400 rounded-full p-8 text-center shadow-xl">
            ...
            <Link href="/week-9" className="bg-pink-600 text-white font-bold py-2 px-6 rounded-full border-2 border-rose-400">
              Go to Login Page
            </Link>
          </div>
        </div>
